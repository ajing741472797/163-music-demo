{
    let view = {
        ...
        `,
        render(data = {}) {
            let placeholders = ['name', 'singer', 'url', 'id', 'cover','background', 'lyrics']
    ...
    let model = {
        data: {
            name: '', singer: '', url: '', id: '', cover: '',background:'', lyrics: ''
        },
        update(data) {
    ...
    let controller = {
        ...
        create() {
            let needs = 'name singer url cover background lyrics'.split(' ')
            let data = {}
            needs.map((string) => {
                data[string] =
